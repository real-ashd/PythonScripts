...
:main
    title Get Wifi Passwords
    
    echo.
    echo Below are your WiFi Passwords
    echo.
...
::
:: Get the WiFi password of a given profile
...
::
:: Get all  profiles (comma separated) into the result result-variable
